...
export default function AdminStocks() {
  const initialStocks = [];
  const Stocks =
    useSelector((state) => state.adminStocks.adminStocks) || initialStocks;
  ...
  const displayedStocks = Array.isArray(Stocks)
    ? Stocks.filter((stock) =>
        ...
        <div className="flex-1 p-4">
          ...
          <div className="mt-32 px-5 pt-3">
            <div className="flex justify-center items-center h-full ml-20">
              <table className="table-auto w-3/6 rounded-md bg-slate-50">
                <thead>
                  ...
                  <th className="px-6 py-3 items-center text-center">
                    <Link to="/adminInsertStocks">
                      <button
                        type="submit"
                        className="flex  w-[126px] items-center bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg transition duration-300 transform hover:scale-105 focus:outline-none focus:ring focus:ring-blue-300 items center"
                      >
                  ...
                  {displayedStocks.length > 0 ? (
                    displayedStocks.map((stock) => (
                      <tr key={stock.product_stock_id}>
                        ...
                        <td className="px-8 py-2 text-center font-mono text-3xl md:text-xl relative">
                          <span
                            className="ml-2 absolute h-2 w-2 rounded-full bg-blue-500 left-2 top-1/2 transform -translate-y-1/2"
                            aria-hidden="true"
                          ></span>
                          {stock.quantity}
                        </td>
                        <td className="flex justify-center items-center px-8 py-2 text-center font-mono text-3xl md:text-xl">
                          <Link
                            to={`/adminEditStock/${stock.product_stock_id}`}
                          >
                          ...
                          <button
                            ...
                            onClick={() => {
                              dispatch(
                                deleteadminProductStocks(stock.product_stock_id)
                              );
